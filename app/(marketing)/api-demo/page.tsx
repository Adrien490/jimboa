...
export default function ApiDemoPage() {
	...
	return (
		<PageContainer>
			<PageHeader title="Démonstration des HTTP Actions" />
					...
					<CardContent>
						<form onSubmit={handleSearch} className="space-y-4">
							...
							<p className="text-sm text-gray-500">
								Cette API permet de récupérer les informations publiques
								d&apos;un groupe via son code d&apos;invitation.
							</p>
						</form>
					</CardContent>
				</Card>
						...
						<div className="space-y-6">
							<div>
								...
								<div className="bg-gray-50 p-3 rounded-md font-mono text-sm">
									curl -X GET
									&quot;https://peaceful-chinchilla-149.convex.site/health&quot;
								</div>
							</div>
							...
							<div>
								...
								<p className="text-sm text-gray-600 mb-2">
									Récupération des informations publiques d&apos;un groupe
								</p>
								<div className="bg-gray-50 p-3 rounded-md font-mono text-sm">
									curl -X GET
									&quot;https://peaceful-chinchilla-149.convex.site/api/groups/info?code=ABC123&quot;
								</div>
							</div>
							...
							<div>
								...
								<p className="text-sm text-gray-600 mb-2">
									Endpoint sécurisé pour les webhooks externes
								</p>
								<div className="bg-gray-50 p-3 rounded-md font-mono text-sm">
									curl -X POST
									&quot;https://peaceful-chinchilla-149.convex.site/webhooks/external&quot;
									\<br />
